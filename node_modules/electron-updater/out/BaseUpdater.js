    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const done = (() => {
        var _ref = (0, _bluebirdLst().coroutine)(function* (isSaveCache) {
          ...
          if (isSaveCache) {
            yield _this2.downloadedUpdateHelper.cacheUpdateInfo(updateFileName);
          }
      ...
      const cachedUpdateFile = yield _this2.downloadedUpdateHelper.validateDownloadedPath(updateFile, updateInfo, fileInfo, log);
      ...
      const removeFileIfAny = (() => {
        var _ref2 = (0, _bluebirdLst().coroutine)(function* () {
          yield _this2.downloadedUpdateHelper.clear().catch(() => {// ignore
          });
